		...
		for (let i = 0; i < pages[page].title.length; i++)	{
			if (pages[page].title[i] != undefined) {
				...
				if (pages[page].extension[i] == "png" || pages[page].extension[i] == "jpg" || pages[page].extension[i] == "jpeg" || pages[page].extension[i] == "gif") {
					insert += "<img id='pg"+page.toString()+"obj"+i+"' style='display:none' src='"+URL+"assets/"+pages[page].title[i]+"_"+pages[page].date[i]+"."+pages[page].extension[i]+"'>";
				} else if (pages[page].extension[i] == "pdf") {
					insert += "<object type='application/pdf' id='pg"+page.toString()+"obj"+i.toString()+"'style='display:none' data='assets/"+pages[page].title[i]+"_"+pages[page].date[i]+"."+pages[page].extension[i]+"'></object>";
				} else if (pages[page].extension[i] == "mp3" || pages[page].extension[i] == "wav") {
					insert += "<audio controls style='display:none' id='pg"+page.toString()+"obj"+i.toString()+"'><source src='assets/"+pages[page].title[i]+"_"+pages[page].date[i]+"."+pages[page].extension[i]+"' type='audio/"+pages[page].extension[i]+"'></audio>";
				} else if (pages[page].extension[i] == "mp4") {
					insert += "<video controls style='display:none' id='pg"+page.toString()+"obj"+i.toString()+"'><source src='assets/"+pages[page].title[i]+"_"+pages[page].date[i]+"."+pages[page].extension[i]+"' type='video/"+pages[page].extension[i]+"'>/video>";
